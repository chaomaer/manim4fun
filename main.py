...
from utils import angle_between, perpen_direction, unit_vector_from_to
...
class Trace345Square(MovingCameraScene):
    def construct(self):
        ...
        #
        while i <= 60:
            result = self.create_tree(group, side_length=side_length, alpha=i * DEGREES, max_depth=max_depth, is_play=(i==45))
            all_group[i] = result
            i = i + 1
